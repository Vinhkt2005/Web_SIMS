-- Script kiểm tra LocalDB
-- Chạy script này để kiểm tra SQL Server LocalDB

-- 1. Kiểm tra LocalDB có hoạt động không
SELECT '=== KIỂM TRA LOCALDB ===' as Info;
...
PRINT '=== KẾT QUẢ ===';
PRINT 'Nếu thấy thông tin trên, LocalDB đang hoạt động bình thường';
